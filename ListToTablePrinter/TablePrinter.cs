...
namespace ListToTablePrinter
{
    public class TablePrinter
    {
        ...
        private static string CreateTable<T>(IEnumerable<T> list, string tableHeader, PropertyInfo[] properties, Dictionary<string, int> columnLengths)
        {
